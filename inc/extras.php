 ...
 */
function academia_pingback_header()
{
	if (is_singular() && pings_open()) {
		echo '<link rel="pingback" href="', bloginfo('pingback_url'), '">';
	}
}
add_action('wp_head', 'academia_pingback_header');
...
add_action('after_setup_theme', 'academia_setup_theme_supported_features');
...
function academia_admin_bar_remove_logo()
{
	global $wp_admin_bar;
	$wp_admin_bar->remove_menu('wp-logo');
}
add_action('wp_before_admin_bar_render', 'academia_admin_bar_remove_logo', 0);
 ...
 */
function academia_gutenberg_disable_all_colors()
{
