...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Omitir e ir al contenido', 'academia' ); ?></a>
	...
	<header id="masthead" class="site-header" role="banner">
		...
		<nav id="site-navigation" class="main-navigation" role="navigation">
			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false">
				<?php echo academia_get_svg( array( 'icon' => 'list' ) ); ?>
				<span class="skip-link screen-reader-text"><?php esc_html_e( 'Primary Menu</span>', 'academia' ); ?></span>
			</button>
	...
	<?php if ( !is_front_page() && is_page() || is_singular('lp_course') ) : ?>
		...
		<?php if ( has_post_thumbnail() ): ?>			
			<div class="full-bleed featured-image">
				<?php
					the_post_thumbnail('academia-full-bleed');
					?>
			</div><!-- .full-bleed -->
		<?php endif; ?>
